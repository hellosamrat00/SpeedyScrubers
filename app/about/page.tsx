    ...
    <main>
      ...
      <section className="pt-40 lg:pt-48 pb-20 relative overflow-hidden" style={{ backgroundColor: "var(--color-brand-blue-dark)" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="font-heading text-5xl md:text-7xl font-bold mb-6 text-white tracking-tight">
            About <span className="italic" style={{ color: "var(--color-brand-yellow)" }}>Speedy Scrubbers</span>
          </h1>
          <p className="max-w-2xl mx-auto text-lg text-white/80 leading-relaxed">
            Founded with a vision to redefine cleanliness, Speedy Scrubbers has been providing top-tier professional cleaning solutions tailored for every space.
          </p>
        </div>
      </section>
      ...
      <section className="py-24" style={{ backgroundColor: "var(--color-brand-light)" }}>
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="font-heading text-4xl font-bold mb-6" style={{ color: "var(--color-brand-blue)" }}>
              A Legacy of <span style={{ color: "var(--color-brand-yellow)" }}>Spotless</span> Excellence
            </h2>
            <p className="text-lg leading-relaxed mb-6" style={{ color: "var(--color-brand-blue)", opacity: 0.8 }}>
            ...
            <p className="text-lg leading-relaxed" style={{ color: "var(--color-brand-blue)", opacity: 0.8 }}>
      ...
      <section className="py-24 bg-white border-t border-b" style={{ borderColor: "rgba(5,38,27,0.05)" }}>
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-heading text-4xl font-bold" style={{ color: "var(--color-brand-blue)" }}>Our Core Values</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={v.title} className="p-8 rounded-2xl border bg-gray-50/50 hover:-translate-y-2 transition-transform" style={{ borderColor: "rgba(5,38,27,0.05)" }}>
                ...
                <h3 className="font-heading text-2xl font-bold mb-3" style={{ color: "var(--color-brand-blue)" }}>{v.title}</h3>
                <p className="leading-relaxed" style={{ color: "var(--color-brand-blue)", opacity: 0.8 }}>{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Stats */}
      <section className="py-20" style={{ backgroundColor: "var(--color-brand-blue)" }}>
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-10">
          {[
            ...
            <div key={stat.label} className="text-center">
              <div className="font-heading text-5xl font-bold mb-2" style={{ color: "var(--color-brand-yellow)" }}>{stat.value}</div>
